...
export async function compareDirectories(left: string, right: string, recursive: boolean): Promise<FileNode[]> {
  return invoke<FileNode[]>('compare_directories', { left, right, recursive });
}
